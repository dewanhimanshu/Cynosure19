...
var geometryTwo, materialTwo, cubeTwo;
//let cubeTwo;
...
function addAnotherBox() {
  geometryTwo = new THREE.BoxGeometry( 0.3, 0.3, 0.3 );
  materialTwo = new THREE.MeshNormalMaterial();

  cubeTwo = new THREE.Mesh( geometryTwo, materialTwo );
  scene.add( cubeTwo );
